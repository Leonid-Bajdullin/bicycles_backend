...
typeorm_1.createConnection().then(function (connection) {
    ...
    app.post("/create_rent", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bicycleRepository.create(req.body)];
                    case 1:
                        newBike = _a.sent();
                        return [4 /*yield*/, bicycleRepository.save(newBike)];
                    case 2:
                        results = _a.sent();
    ...
    app.put("/rent_bike/:id", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bicycleRepository.findOne(req.params.id)];
                    case 1:
                        bike = _a.sent();
                        bike.is_rented = true;
